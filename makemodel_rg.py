...
# Compute average Rg, Dmax and MW:
avrgRg   = np.mean(parameters, axis=0)[0]
#avrgDmax = np.mean(parameters, axis=0)[1]
#avrgMW   = np.mean(parameters, axis=0)[2]
#FIXME: (We've computed this once and used as constants above)
