...
parser.add_argument('-a', '--slope',type=float, help='Sigma for a. <a> = 0; sample = (sample + buffer) - c*(buffer + (A*s + b)')
parser.add_argument('-b', '--shift',type=float, help='Sigma for b. <b> = 0; sample = (sample + buffer) - c*(buffer + (a*s + B)')
parser.add_argument('-c', '--scale',type=float, help= 'Sigma for c. <c> = 1; sample = (sample + buffer) - C*(buffer + (a*s + b)')
